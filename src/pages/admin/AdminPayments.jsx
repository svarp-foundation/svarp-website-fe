  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex justify-between items-end">
        ...
        <button
          onClick={exportCSV}
          className="bg-white border border-slate-200 text-primary font-bold px-6 py-2.5 rounded-xl hover:bg-slate-50 transition-all text-sm flex items-center gap-2 shadow-sm"
        >
          📥 Export CSV
        </button>
      </div>
